...
def rectangle_random_select(x1, y1, x2, y2, x3, y3, x4, y4):
    h = math.sqrt(abs(x1 - x4)**2 + abs(y1 - y4)**2)
    w = math.sqrt(abs(x1 - x2)**2 + abs(y1 - y2)**2)

    x = x2 - random.random() * w
    y = y2 + random.random() * h

    return x, y

def irregular_random_select(vertices):
    # Create a polygon from the vertices
    polygon = Polygon(vertices)

    # Generate a single random point within the polygon
...
def move_and_read_data(count):
    ...
    P = [(257.2, -42.5), (254.0, -61.6), (246.4, -71.7), (234.2, -71.5), (224.0, -68.8), (213.3, -65.2), (196.6, -74.3), (168.2, -89.3), (156.0, -79.3), (154.2, -69.2), (157.7, -35.2), (170.9, -27.3), (190.2, -36.6), (204.4, -35.6), (217.0, -31.3), (229.9, -19.4), (240.3, -18.1), (240.0, -17.6), (246.9, -19.0), (254.9, -29.5)]

    x, y = irregular_random_select(P)
    print("=====================Count:", count + 1)
